import{r as d,j as a}from"./react-vendor-Bsy9czSr.js";const y="modulepreload",b=function(r){return"/"+r},u={},x=function(p,s,m){let v=Promise.resolve();if(s&&s.length>0){let f=function(e){return Promise.all(e.map(n=>Promise.resolve(n).then(t=>({status:"fulfilled",value:t}),t=>({status:"rejected",reason:t}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),i=o?.nonce||o?.getAttribute("nonce");v=f(s.map(e=>{if(e=b(e),e in u)return;u[e]=!0;const n=e.endsWith(".css"),t=n?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${e}"]${t}`))return;const l=document.createElement("link");if(l.rel=n?"stylesheet":y,n||(l.as="script"),l.crossOrigin="",l.href=e,i&&l.setAttribute("nonce",i),document.head.appendChild(l),n)return new Promise((g,h)=>{l.addEventListener("load",g),l.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${e}`)))})}))}function c(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return v.then(o=>{for(const i of o||[])i.status==="rejected"&&c(i.reason);return p().catch(c)})},w=({onClose:r,onOpenGuide:p,selectedHue:s="noir"})=>{const[m,v]=d.useState(null),[c,o]=d.useState(null),i=d.useRef(null);d.useEffect(()=>{let n=!1;return x(()=>Promise.resolve().then(()=>C),void 0).then(t=>{!n&&typeof t.default=="string"&&v(t.default)}).catch(t=>{n||o(t?.message||"Failed to load platform")}),()=>{n=!0}},[]),d.useEffect(()=>(document.body.style.overflow="hidden",()=>{document.body.style.overflow=""}),[]),d.useEffect(()=>{const n=t=>{t.key==="Escape"&&r()};return document.addEventListener("keydown",n),()=>document.removeEventListener("keydown",n)},[r]),d.useEffect(()=>{const n=t=>{t.data?.type==="CLOSE_PLATFORM"&&t.origin===window.location.origin&&r(),t.data?.type==="SCROLL_TO_FINANCIAL_GUIDE"&&p&&p()};return window.addEventListener("message",n),()=>window.removeEventListener("message",n)},[r,p]),d.useEffect(()=>{const n=i.current?.contentWindow;n&&n.postMessage({type:"SET_HUE",hue:s},"*")},[s,m]);const f={noir:{overlayBackground:"radial-gradient(circle at 12% -8%, rgba(201, 169, 98, 0.2), transparent 28%), radial-gradient(circle at 88% 0%, rgba(142, 200, 216, 0.12), transparent 30%), #0a0a0a",topBorder:"#2d2d2d",topBackground:"linear-gradient(180deg, rgba(201, 169, 98, 0.08), transparent 55%), rgba(9, 9, 9, 0.92)",titleColor:"#c9a962",closeBorder:"#333333",closeColor:"#b0a287",loadingBorder:"#2f2f2f",loadingBackground:"linear-gradient(180deg, rgba(201, 169, 98, 0.06), transparent 45%), #101010",loadingMeta:"#a39a88",loadingDot:"#c9a962",loadingTrack:"linear-gradient(90deg, rgba(223, 200, 138, 0.14), rgba(223, 200, 138, 0.34), rgba(223, 200, 138, 0.14))",loadingSweep:"linear-gradient(90deg, transparent, rgba(255, 244, 213, 0.95), transparent)",errorText:"#a3a3a3",errorButtonBg:"#262626",errorButtonBorder:"#404040",errorButtonText:"#e5e5e5"},midnight:{overlayBackground:"radial-gradient(circle at 12% -8%, rgba(126, 168, 255, 0.2), transparent 30%), radial-gradient(circle at 88% 0%, rgba(143, 197, 235, 0.14), transparent 32%), #090d16",topBorder:"#2a3a5b",topBackground:"linear-gradient(180deg, rgba(126, 168, 255, 0.1), transparent 55%), rgba(9, 13, 22, 0.92)",titleColor:"#a9c3ff",closeBorder:"#33476f",closeColor:"#bcd0f3",loadingBorder:"#314972",loadingBackground:"linear-gradient(180deg, rgba(126, 168, 255, 0.08), transparent 45%), #10192b",loadingMeta:"#9ab1db",loadingDot:"#7ea8ff",loadingTrack:"linear-gradient(90deg, rgba(169, 195, 255, 0.2), rgba(169, 195, 255, 0.36), rgba(169, 195, 255, 0.2))",loadingSweep:"linear-gradient(90deg, transparent, rgba(219, 232, 255, 0.95), transparent)",errorText:"#c0cce2",errorButtonBg:"#18253f",errorButtonBorder:"#2f4369",errorButtonText:"#e6efff"},emerald:{overlayBackground:"radial-gradient(circle at 12% -8%, rgba(116, 198, 165, 0.22), transparent 28%), radial-gradient(circle at 88% 0%, rgba(135, 207, 196, 0.15), transparent 32%), #09140f",topBorder:"#2f584a",topBackground:"linear-gradient(180deg, rgba(116, 198, 165, 0.1), transparent 55%), rgba(9, 20, 15, 0.92)",titleColor:"#9ee2c5",closeBorder:"#3a6b5a",closeColor:"#b4dfcf",loadingBorder:"#325c4f",loadingBackground:"linear-gradient(180deg, rgba(116, 198, 165, 0.08), transparent 45%), #102119",loadingMeta:"#8fbda9",loadingDot:"#74c6a5",loadingTrack:"linear-gradient(90deg, rgba(158, 226, 197, 0.18), rgba(158, 226, 197, 0.34), rgba(158, 226, 197, 0.18))",loadingSweep:"linear-gradient(90deg, transparent, rgba(221, 255, 243, 0.94), transparent)",errorText:"#c3e1d5",errorButtonBg:"#183126",errorButtonBorder:"#355d4f",errorButtonText:"#e9fff5"},daylight:{overlayBackground:"radial-gradient(circle at 12% -8%, rgba(166, 123, 54, 0.2), transparent 30%), radial-gradient(circle at 88% 0%, rgba(61, 131, 155, 0.12), transparent 34%), #f6f2e8",topBorder:"#d8cab0",topBackground:"linear-gradient(180deg, rgba(166, 123, 54, 0.08), transparent 55%), rgba(246, 242, 232, 0.93)",titleColor:"#835f25",closeBorder:"#ccb892",closeColor:"#6f5f4a",loadingBorder:"#d8cab0",loadingBackground:"linear-gradient(180deg, rgba(166, 123, 54, 0.08), transparent 45%), #fffdfa",loadingMeta:"#6f5f4a",loadingDot:"#a67b36",loadingTrack:"linear-gradient(90deg, rgba(191, 149, 83, 0.16), rgba(191, 149, 83, 0.3), rgba(191, 149, 83, 0.16))",loadingSweep:"linear-gradient(90deg, transparent, rgba(143, 103, 38, 0.95), transparent)",errorText:"#6b5b43",errorButtonBg:"#efe7d8",errorButtonBorder:"#ccb892",errorButtonText:"#3d3223"}},e=f[s]||f.noir;return a.jsxs("div",{style:{position:"fixed",inset:0,zIndex:9999,background:e.overlayBackground,display:"flex",flexDirection:"column"},role:"dialog","aria-modal":"true","aria-label":"Financial Intelligence Platform",children:[a.jsx("style",{children:`@keyframes fpPulse {
          ...
          .fp-loading-dot {
            ...
            height: 8px;
            border-radius: 999px;
            background: ${e.loadingDot};
            animation: fpPulse 1.8s ease-out infinite;
          }`}),a.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0.75rem clamp(0.9rem, 2vw, 1.25rem)",borderBottom:`1px solid ${e.topBorder}`,backdropFilter:"blur(10px)",background:e.topBackground,flexShrink:0,gap:"0.75rem"},children:[a.jsx("span",{style:{fontFamily:"var(--font-sans)",fontSize:"0.75rem",fontWeight:600,letterSpacing:"0.16em",textTransform:"uppercase",color:e.titleColor,flex:"1",minWidth:0,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:"Financial Intelligence Platform"}),a.jsx("button",{onClick:r,style:{background:"transparent",border:`1px solid ${e.closeBorder}`,color:e.closeColor,cursor:"pointer",fontSize:"1.125rem",padding:"0.375rem 0.625rem",lineHeight:1,borderRadius:"8px"},"aria-label":"Close",children:"✕"})]}),a.jsxs("div",{style:{flex:1,minHeight:0,position:"relative"},children:[c&&a.jsxs("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",flexDirection:"column",gap:"1rem",color:e.errorText,fontFamily:"var(--font-sans)",fontSize:"0.875rem"},children:[a.jsx("span",{children:c}),a.jsx("button",{type:"button",onClick:r,style:{padding:"0.5rem 1rem",background:e.errorButtonBg,border:`1px solid ${e.errorButtonBorder}`,color:e.errorButtonText,cursor:"pointer",borderRadius:"4px"},children:"Close"})]}),!c&&!m&&a.jsx("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center"},children:a.jsxs("div",{className:"fp-loading-shell","aria-live":"polite",children:[a.jsx("div",{className:"fp-loading-line"}),a.jsxs("div",{className:"fp-loading-meta",children:[a.jsx("span",{className:"fp-loading-dot"}),a.jsx("span",{children:"Loading financial platform"})]})]})}),!c&&m&&a.jsx("iframe",{ref:i,srcDoc:m,title:"Financial Intelligence Platform",style:{position:"absolute",inset:0,width:"100%",height:"100%",border:"none",display:"block"},sandbox:"allow-scripts allow-same-origin allow-forms allow-popups allow-popups-to-escape-sandbox",onLoad:()=>{i.current?.contentWindow?.postMessage({type:"SET_HUE",hue:s},"*")}})]})]})},R=Object.freeze(Object.defineProperty({__proto__:null,default:w},Symbol.toStringTag,{value:"Module"})),E=`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
body{background:radial-gradient(circle at 20% -10%, color-mix(in srgb,var(--accent) 22%,transparent), transparent 32%),radial-gradient(circle at 82% 0%, color-mix(in srgb,var(--cyan) 16%,transparent), transparent 34%),var(--bg);color:var(--text);font-family:var(--body);min-height:100vh;overflow-x:hidden;}
body::before{content:'';position:fixed;inset:0;background-image:linear-gradient(color-mix(in srgb,var(--accent) 12%,transparent) 1px,transparent 1px),linear-gradient(90deg,color-mix(in srgb,var(--accent) 12%,transparent) 1px,transparent 1px);background-size:42px 42px;pointer-events:none;z-index:0;}

/* NAV */
.nav{position:-webkit-sticky;position:sticky;top:0;z-index:200;background:color-mix(in srgb,var(--bg) 88%,transparent);-webkit-backdrop-filter:blur(18px);backdrop-filter:blur(18px);border-bottom:1px solid var(--border2);display:flex;align-items:center;padding:0 clamp(16px,3vw,40px);height:60px;gap:clamp(8px,1.6vw,18px);box-shadow:0 10px 24px color-mix(in srgb,var(--text) 16%,transparent);}
.nav-brand{font-family:var(--display);font-size:16px;font-weight:700;letter-spacing:.03em;color:var(--text);text-transform:none;margin-right:clamp(22px,3vw,44px);flex-shrink:0;white-space:nowrap;}
.nav-brand span{color:var(--accent2);}
.nav-tabs{display:flex;gap:0;flex:1;overflow-x:auto;min-width:0;}
.nav-tab{padding:0 18px;height:60px;display:flex;align-items:center;gap:8px;font-family:var(--mono);font-size:13px;font-weight:500;letter-spacing:1px;text-transform:uppercase;color:var(--muted2);cursor:pointer;border-bottom:2px solid transparent;transition:all .2s;white-space:nowrap;flex-shrink:0;}
...
.nav-right{margin-left:auto;font-family:var(--mono);font-size:13px;color:var(--muted2);letter-spacing:1px;flex-shrink:0;padding-left:24px;}
...
.pane-sub{font-size:14px;color:var(--muted2);font-weight:400;line-height:1.82;max-width:700px;margin-bottom:32px;}
.source-tags{display:flex;gap:8px;flex-wrap:wrap;margin-bottom:36px;}
.stag{font-family:var(--mono);font-size:12px;letter-spacing:1px;border:1px solid var(--border2);padding:4px 10px;color:var(--muted2);text-transform:uppercase;border-radius:3px;}
...
/* SECTION HEADER */
.sh{font-family:var(--display);font-size:12px;font-weight:700;letter-spacing:2.2px;text-transform:uppercase;color:var(--accent);display:flex;align-items:center;gap:10px;margin-bottom:18px;}
...
.ig-label{font-family:var(--mono);font-size:12px;letter-spacing:1px;color:var(--muted2);text-transform:uppercase;margin-bottom:7px;}
...
.m-lbl{font-family:var(--mono);font-size:12px;letter-spacing:1px;color:var(--muted2);text-transform:uppercase;margin-bottom:5px;}
.m-val{font-family:var(--display);font-size:28px;font-weight:700;line-height:1;}
.m-sub{font-size:14px;color:var(--muted2);margin-top:3px;}
...
.panel-title{font-family:var(--mono);font-size:12px;color:var(--accent);letter-spacing:1.2px;margin-bottom:14px;text-transform:uppercase;}
...
.verdict-wrap::before{content:attr(data-label);position:absolute;top:-10px;left:20px;background:var(--bg);padding:0 12px;font-family:var(--mono);font-size:10px;letter-spacing:1.8px;color:var(--accent);}
...
.data-table th{font-size:10px;letter-spacing:1.6px;text-transform:uppercase;color:var(--accent);padding:9px 13px;background:var(--s2);border:1px solid var(--border);text-align:left;font-weight:700;}
...
.strip-src{font-size:11px;color:var(--muted);margin-left:auto;display:flex;align-items:center;gap:6px;flex-shrink:0;}
...
.cc-meta{font-family:var(--mono);font-size:11px;color:var(--muted2);display:flex;flex-direction:column;gap:2px;}
...
.pc-name{font-size:12px;color:var(--muted2);flex:1;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}
...
.dalio-label{font-family:var(--display);font-size:12px;font-weight:700;letter-spacing:1px;margin-bottom:6px;}
.dalio-desc{font-size:12px;color:var(--muted2);line-height:1.6;margin-bottom:10px;}
.dalio-assets{font-family:var(--mono);font-size:11px;color:var(--muted2);letter-spacing:1px;}
...
.f-link{color:var(--accent2);text-decoration:none;font-family:var(--mono);font-size:12px;}
.f-link:hover{text-decoration:underline;}

/* FOOTBALL FIELD */
.ff-row{margin-bottom:12px;}
.ff-lbl{display:flex;justify-content:space-between;font-family:var(--mono);font-size:12px;color:var(--muted2);margin-bottom:4px;}
...
.ff-fill span{font-family:var(--mono);font-size:11px;white-space:nowrap;}
...
.viz-title{font-family:var(--mono);font-size:12px;letter-spacing:1.4px;color:var(--accent);text-transform:uppercase;margin-bottom:14px;}
...
.viz-fcf-bar span{position:absolute;bottom:100%;left:50%;transform:translateX(-50%);font-family:var(--mono);font-size:10px;color:var(--muted2);white-space:nowrap;margin-bottom:4px;}
...
.viz-filings-day-lbl{font-family:var(--mono);font-size:10px;color:var(--muted2);text-align:center;margin-top:6px;}
.viz-macro-row{display:flex;align-items:center;gap:12px;margin-bottom:10px;}
.viz-macro-row:last-child{margin-bottom:0;}
.viz-macro-lbl{font-family:var(--mono);font-size:11px;color:var(--muted2);width:90px;flex-shrink:0;}
...
.sens th{background:var(--s2);border:1px solid var(--border);padding:8px 11px;font-size:11px;letter-spacing:1.6px;color:var(--accent);font-weight:700;text-align:center;}
...
.loading-msg{font-family:var(--mono);font-size:12px;color:var(--muted2);letter-spacing:1.1px;text-transform:uppercase;display:flex;align-items:center;gap:8px;}
...
.notice-box{background:rgba(255,204,68,.04);border:1px solid rgba(255,204,68,.2);padding:12px 18px;color:var(--yellow);font-family:var(--mono);font-size:12px;display:none;margin-bottom:18px;line-height:1.6;}
.notice-box.show{display:block;}
.disc{font-size:12px;color:#7f7666;line-height:1.7;border-top:1px solid var(--border);padding-top:18px;margin-top:18px;}
.help-link{display:inline-flex;align-items:center;gap:6px;font-family:var(--mono);font-size:12px;letter-spacing:1px;color:var(--muted2);text-decoration:none;margin-bottom:14px;cursor:pointer;transition:color .2s;}
.help-link:hover{color:var(--accent);}
.viz-desc{font-size:13px;color:var(--muted2);line-height:1.65;margin-top:4px;margin-bottom:12px;}
/* Custom hover tooltips */
[data-tooltip]{cursor:help;position:relative;}
#fp-tooltip{position:fixed;z-index:9999;max-width:360px;padding:11px 14px;background:var(--s2);border:1px solid var(--accent);border-radius:6px;font-size:14px;line-height:1.6;color:var(--text);white-space:normal;pointer-events:none;opacity:0;transition:opacity .15s ease;box-shadow:0 6px 24px rgba(0,0,0,.45);}
#fp-tooltip.show{opacity:1;}
#fp-tooltip .fp-tt-title{font-family:var(--mono);font-size:12px;letter-spacing:1px;color:var(--accent);margin-bottom:4px;text-transform:uppercase;}
#fp-tooltip .fp-tt-desc{color:var(--text);}
#fp-tooltip .fp-tt-example{font-size:13px;color:var(--muted2);margin-top:6px;border-top:1px solid var(--border);padding-top:6px;}
#fp-tooltip .fp-tt-input{font-size:13px;color:var(--accent);margin-top:4px;}
...
@media(max-width:760px){
  ...
  .nav-tab{height:44px;padding:0 12px;font-size:12px;letter-spacing:1px;}
  .nav-right{display:none;}
  .nav-back-link{order:1!important;margin-left:auto!important;height:48px!important;border-left:none!important;padding:0 0 0 12px!important;font-size:12px!important;letter-spacing:1px!important;}

  /* Content */
  .tool-pane{padding:18px 14px 80px;}
  .pane-sub{font-size:14px;margin-bottom:20px;}
  .source-tags{margin-bottom:20px;}
  .stag{font-size:11px;padding:2px 8px;}
  ...
  .f-date{display:none;}
  .f-link{font-size:11px;letter-spacing:.5px;}
  ...
  .panel-row span{text-align:left;font-size:13px;}
  ...
  /* Run button */
  .run-btn{padding:15px;font-size:13px;letter-spacing:1.5px;}
  ...
  .viz-macro-lbl{width:74px;font-size:10px;}
}
...
<nav class="nav">
  ...
  <button class="nav-back-link" onclick="if(window.parent!==window){try{window.parent.postMessage({type:'CLOSE_PLATFORM'},window.location.origin||'*');}catch(_){window.parent.postMessage({type:'CLOSE_PLATFORM'},'*');}}else{window.history.back();}" style="margin-left:20px;font-family:var(--mono);font-size:12px;letter-spacing:1.3px;color:var(--muted2);background:none;text-decoration:none;white-space:nowrap;padding:0 12px;display:flex;align-items:center;gap:6px;height:58px;border:none;border-left:1px solid var(--border);transition:color .2s;cursor:pointer;" onmouseover="this.style.color='var(--text)'" onmouseout="this.style.color='var(--muted2)'">← PORTFOLIO</button>
</nav>
...
<div class="tool-pane active" id="pane-deals">
  ...
  <div id="d-results" style="display:none">
    ...
    <div class="viz-wrap" id="d-viz-fcf" style="display:none">
      ...
      <div class="viz-fcf-summary" id="d-viz-fcf-summary" style="font-family:var(--mono);font-size:11px;color:var(--accent);margin-top:10px"></div>
    </div>
...
<div class="tool-pane" id="pane-screen">
  ...
  <div id="sc-results" style="display:none">
    <div class="sh" data-tooltip="SEC EDGAR search results. Type = form (8-K, S-4, etc.); Company = filer; Filed = date. Link opens EDGAR." data-tooltip-example="Real life: Click EDGAR to read the full filing on sec.gov.">Live Deal Filings <span id="sc-count" style="font-family:var(--body);font-weight:300;font-size:11px;letter-spacing:0;color:var(--muted2);text-transform:none"></span></div>
...
</html>`,C=Object.freeze(Object.defineProperty({__proto__:null,default:E},Symbol.toStringTag,{value:"Module"}));export{x as _,R as i};
